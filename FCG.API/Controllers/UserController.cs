...
public class UserController : ControllerBase
{
    ...
    [SwaggerOperation(summary: "Create a new admin", Description = "This endpoint receive the new admin data and persists in database")]
    [SwaggerResponse(201, "Admin created sucessfuly")]
    [SwaggerResponse(409, "Email already in use")]
    [Authorize(Roles = "Admin")]
    [HttpPost("Admin")]
    public async Task<ActionResult<ResponseUserDto>> PostAdminUser([FromBody] CreateUserDto createUserDto, CancellationToken cancellationToken)
    {
        var result = await _userService.CreateAdminUser(createUserDto, cancellationToken);
    ...
    [SwaggerOperation(summary: "Update an user", Description = "This endpoint receive the user data to update a user")]
